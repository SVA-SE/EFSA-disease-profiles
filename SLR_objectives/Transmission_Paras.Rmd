...
<br><br>
Data collected from matrices other than blood, and calculations of the infectious period accounting for censoring (lack of information about true maximum when experiments ended while the agent was still detectable) are available further below.
...
inf.plots(dataset=dfDZ,
          ...
          agent.type="parasite")%>% layout(font=plots.font)
...
```{r, results='asis'}
if(file.exists("transmission_ma9.png")|file.exists("transmission_ma10.png")|file.exists("transmission_ma3.png")
...
```{r, results='asis'}
if(file.exists("transmission_ma9.png")){
  cat("\nRow\n-----------------------------------------------------------------------\n")
...
```{r}
if(file.exists("transmission_ma9.png")){
  include_graphics("transmission_ma9.png",
                 auto_pdf=FALSE)
}
```
...
```{r, results='asis'}
if(file.exists("transmission_ma10.png")){
  cat("\nRow\n-----------------------------------------------------------------------\n")
...
```{r}
if(file.exists("transmission_ma10.png")){
  include_graphics("transmission_ma10.png",
                 auto_pdf=FALSE)
}
```
...
```{r, results='asis'}
if(file.exists("transmission_ma9.png")|file.exists("transmission_ma10.png")){
  cat("\nRow\n-----------------------------------------------------------------------\n")
