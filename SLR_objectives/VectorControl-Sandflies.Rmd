...
vector <- "sandflies"
dfVCsf <- dfvc[dfvc$studyTarget_vector==vector,]
dfVCsf$studyTarget_host <- as.factor(as.character(dfVCsf$studyTarget_host))
...
df1 <- dfVCsf %>% filter (studyTarget_host != "NOT HOST SPECIFIC")
...
<button type="button" class="btn btn-link" data-toggle="modal" data-target="#spray">
<img src=../../../../templates/assets/css/images/info.png>
</button>

<!-- Modal -->
<div class="modal fade" id="spray" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-body">
Boxes with a dark blue contour refer to studies reporting vector MORTALITY, rather than substance efficacy (which is calculated as the mortality in the experimental group in comparison to a control group). 
...
<button type="button" class="btn btn-link" data-toggle="modal" data-target="#oral">
<img src=../../../../templates/assets/css/images/info.png>
</button>

<!-- Modal -->
<div class="modal fade" id="oral" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-body">
Boxes with a dark blue contour refer to studies reporting vector MORTALITY, rather than substance efficacy (which is calculated as the mortality in the experimental group in comparison to a control group). 
...
df2 <- dfVCsf %>% filter (studyTarget_host == "NOT HOST SPECIFIC")
...
datatable(unique(references[references$Refid%in%dfVCsf$refID,c(1,4,5,9)]), filter = 'top', rownames=FALSE)
